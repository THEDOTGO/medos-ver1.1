...
(function (d) {
    function l(a, c) {
        ...
        this.blockCover = c.blockCover;
        this.changeHash = c.changeHash;
    ...
    l.prototype = {
        ...
        showPage: function (a, c) {
            ...
            this.positionBookShadow(); !1 !== c && this.opts.updateBrowserURL && this.locationHashToPage() != a && (this.changeHash && (this.locationHashSetTo = window.location.hash = this.pageToLocationHash(a)));
            this.showThumbnail()
        },
...
(function (d) {
    ...
    function l(p) {
        ...
        if (block) return;
        block = !block;
        setTimeout(function () { block = !block; }, 2000)
